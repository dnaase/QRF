...
my $tmp_loc=$loc_bed.".tmp_loc.bed";
...
my $tmp_out=$prefix.".alignTo.$bw_prefix.min_data-$min_data.tmp_out.tab";
my $tmp_paste=$prefix.".alignTo.$bw_prefix.min_data-$min_data.tmp_paste.tab";
